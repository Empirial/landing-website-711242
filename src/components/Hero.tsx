    ...
    <section className="bg-background">
      <div className="mx-auto flex max-w-5xl flex-col items-center px-4 py-20 text-center sm:py-24 lg:py-28">
        <h1 className="max-w-3xl text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
          A Brighter, More Confident Smile Starts Here
        </h1>
        <p className="mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
          Expert dental care tailored to your unique needs. Experience comfort and precision in every visit.
        </p>
        <img
          src="https://placehold.co/960x640/e2e8f0/475569?text=hero"
          alt="A person with a radiant, healthy smile looking warmly toward the camera"
